...
configuration multi_seg of mem_ctrl is
	for mult_seg_arch end for;
end configuration;

configuration dois_seg of mem_ctrl is
	for two_seg_arch end for;
end configuration;

--configuration ifsc_v3 of mem_ctrl is
--	for one_seg_wrong_arch end for;
--end configuration;

configuration atribuicao_de_estado of mem_ctrl is
	for state_assign_arch end for;
end configuration;

--configuration ifsc_v5 of mem_ctrl is
--	for plain_buffer_arch end for;
--end configuration;

--configuration ifsc_v6 of mem_ctrl is
--	for look_ahead_buffer_arch end for;
--end configuration;